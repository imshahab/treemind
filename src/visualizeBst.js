...
// sample tree setup
const bst = new BST()
bst.insert(new Task(5, 'Task 5', new Date(Date.now() + 3600000), 1))
bst.insert(new Task(3, 'Task 3', new Date(Date.now() + 7200000), 1))
bst.insert(new Task(7, 'Task 7', new Date(Date.now() + 1800000), 1))
bst.insert(new Task(2, 'Task 2', new Date(Date.now() + 5400000), 1))
bst.insert(new Task(4, 'Task 4', new Date(Date.now() + 10800000), 1))
bst.insert(new Task(6, 'Task 6', new Date(Date.now() + 12600000), 1))
bst.insert(new Task(8, 'Task 8', new Date(Date.now() + 9000000), 1))
bst.insert(new Task(1, 'Task 1', new Date(Date.now() + 4500000), 1))
bst.insert(new Task(9, 'Task 9', new Date(Date.now() + 6300000), 1))
bst.insert(new Task(10, 'Task 10', new Date(Date.now() + 2700000), 1))
bst.insert(new Task(11, 'Task 11', new Date(Date.now() + 8100000), 1))
